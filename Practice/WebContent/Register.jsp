...
<title>Repository Registration</title>
<style>
body {
...
<form action="Reposervlet" method="post">
  <div class="container">
    ...
    <label for="empname"><b>Emp Name</b></label>
    <input type="text" placeholder="Enter Emp Name" name="empname" required>

	<label for="deptcode"><b>Dept Code</b></label>
    <input type="text" placeholder="Enter Dept code" name="deptcode" required>
  ...
  <div class="container signin">
    <p>Already have an account? <a href="http://localhost:8086/Practice/Login.jsp">Log in</a>.</p>
  <b></b>  
  </div> 
